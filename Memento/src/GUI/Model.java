...
import DnD.CharacterCreator.DnDRace.Halfling.HalflingFactory;
import DnD.CharacterCreator.DnDRace.Hobgobling.HobgoblinFactory;
...
public class Model {
    ...
    void setCha(String name, String cla, String race) {
        ...
        if(race.contains("Hobgoblin")){factory= (RaceAbstractFactory) new HobgoblinFactory();}
        else if(race.contains("Halfling")){factory= (RaceAbstractFactory) new HalflingFactory();}
